...
#NoEnv
/*
https://www.autohotkey.com/boards/viewtopic.php?t=60942  
...
CREATE_SAVED_WINDOW(){
	...
	Gui,4:Font,caaaaaa s9 w500,Segoe ui
...
ADD_GREYSCALE_SLIDERS(){
	Gui, 3:Font,caaaaaa s9 w600 , Segoe UI
...
ADD_RGB_SLIDERS(){
	...
	Gui, 3:Font,cffffff s9 w600 , Segoe UI
...
Create_Main_Window(){
	...
	Gui, 1: Color,112343 
	Gui,1:Font,caaaaaa s9 w600 , Segoe UI
...
CREATE_RANDOM_WINDOW(){
	...
	Gui,5:Font,cdddddd s9 ,Segoe Ui
